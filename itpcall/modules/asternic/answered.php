...
<div id="main">
    ...
    <div id="contents">
        ...
        <BR>    
        <a name='1'></a>
        <TABLE width='80%' cellpadding=3 cellspacing=3 border=0 class='sortable' id='table1' >
        <CAPTION>
        ...
        <BR>    
            ...
            if($total_calls2>0) {
                ...
                echo "<TABLE width='80%' cellpadding=3 cellspacing=3 border=0>\n";
                echo "<THEAD>\n";
            ...
            <TD valign=top width='50%' bgcolor='#fffdf3'>
                <TABLE width='80%' cellpadding=1 cellspacing=1 border=0 class='sortable' id='table2'>
                <THEAD>
                <TR> 
          ...
          <BR>
            ...
            if($totaltransfers>0) {
            ?>
            <TABLE width='80%' cellpadding=1 cellspacing=1 border=0 class='sortable' id='table5'>
