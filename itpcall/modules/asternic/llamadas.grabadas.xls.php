...
header("Content-Disposition: <span class='IL_AD' id='IL_AD7'>attachment</span>; filename=listado.duracion.llamada.xls");
header("Pragma: no-cache");
header("Expires: 0");

include_once('../datos/reporte.llamadas.grabadas.lista.php') ?>
