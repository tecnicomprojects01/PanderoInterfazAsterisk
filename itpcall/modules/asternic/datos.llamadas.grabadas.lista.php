...
//$tipo='o';
	//$where .= " tipo like '%".$tipo."%' and";

/*if(!empty($_REQUEST['cbtipo'])){
	$tipo = ($_REQUEST['cbtipo']==0 ? "%%" : $_REQUEST['cbtipo']);
	//$where .= " recordagent like '%".$_REQUEST['anexo']."%' and ";
	$where .= " tipo like '%".$_REQUEST['cbtipo']."%' and ";
*/
...
/*if(!empty($_REQUEST['EStipo'])){

if($_REQUEST['EStipo']==1){$where .= " tipo like '%i%' and ";}
if{$_REQUEST['EStipo']==2){$where .= " tipo like '%o%' and ";}
if($_REQUEST['EStipo']==0){$where .= " tipo like '%%' and ";}
*/
if(!empty($_REQUEST['chkent']) || !empty($_REQUEST['chksal'])){		
	if($_REQUEST['chkent']==0 && $_REQUEST['chksal']==0){ $where .= " tipo = '' and "; }
	if($_REQUEST['chkent']==1 && $_REQUEST['chksal']==1){ $where .= " tipo like '%%' and "; }
	if($_REQUEST['chkent']==1 && $_REQUEST['chksal']==0){ $where .= " tipo like '%i%' and "; }
	if($_REQUEST['chkent']==0 && $_REQUEST['chksal']==1){ $where .= " tipo like '%o%' and "; }
}else{
	$where .= " tipo = 'i' and ";
}
