...
mkdir("/var/www/html/grabaciones/descargas/".$directorio."/",0777);
chmod("/var/www/html/grabaciones/descargas/".$directorio."/", 0777);
...
copy($arraudios[$x],"/var/www/html/grabaciones/descargas/".$directorio."/".$fileaudio);
...
echo "<a href='descargas/".$directorio.".zip' target='_blank'><img src='images/fbDownload.gif'>Descarga => ".$directorio."</a>";
?>