...
<head>
<link type="image/x-icon" href="/itperu.v2/logo_itperu.ico" rel="shortcut icon"/>
...
if(!isset($_SESSION['QSTATS']['queue'])) {include("../menu.php");
echo "<br>";
echo "<br>";
...
<table class='sortable' border="0" cellspacing="0" cellpadding="8" width='60%'>
<tr>
   <td>
