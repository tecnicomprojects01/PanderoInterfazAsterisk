...
//$FG_COL_QUERY='calldate, channel, src, clid, lastapp, lastdata, dst, serverid, disposition, billsec';
...
<tbody>
			...
			<tr>
        		<td  align="left"><b>Select the day</b>
				</td>
			...
			<tr>
				...
				<td align="left"><INPUT TYPE="text" NAME="dst" value="<?=$dst?>"></td>
				<td align="left"><input type="radio" NAME="dsttype" value="1" <?if((!isset($dsttype))||($dsttype==1)){?>checked<?}?>>Exact</td>
				<td align="left"><input type="radio" NAME="dsttype" value="2" <?if($dsttype==2){?>checked<?}?>>Begins with</td>
				<td align="left"><input type="radio" NAME="dsttype" value="3" <?if($dsttype==3){?>checked<?}?>>Contains</td>
				<td align="left"><input type="radio" NAME="dsttype" value="4" <?if($dsttype==4){?>checked<?}?>>Ends with</td>
				
			</tr>			
			<tr>
				<td align="left"><strong>Source</strong></td>				
				<td align="left"><INPUT TYPE="text" NAME="src" value="<?echo "$src";?>"></td>
				<td align="left"><input type="radio" NAME="sourcetype" value="1" <?if((!isset($sourcetype))||($sourcetype==1)){?>checked<?}?>>Exact</td>
				<td align="left"><input type="radio" NAME="sourcetype" value="2" <?if($sourcetype==2){?>checked<?}?>>Begins with</td>
				<td align="left"><input type="radio" NAME="sourcetype" value="3" <?if($sourcetype==3){?>checked<?}?>>Contains</td>
				<td align="left"><input type="radio" NAME="sourcetype" value="4" <?if($sourcetype==4){?>checked<?}?>>Ends with</td>
				
			</tr>
			<tr>
				<td align="left"><b>Cli</b></td>				
				<td align="left"><INPUT TYPE="text" NAME="clid" value="<?=$clid?>"></td>
				<td align="left"><input type="radio" NAME="clidtype" value="1" <?if((!isset($clidtype))||($clidtype==1)){?>checked<?}?>>Exact</td>
				<td align="left"><input type="radio" NAME="clidtype" value="2" <?if($clidtype==2){?>checked<?}?>>Begins with</td>
				<td align="left"><input type="radio" NAME="clidtype" value="3" <?if($clidtype==3){?>checked<?}?>>Contains</td>
				<td align="left"><input type="radio" NAME="clidtype" value="4" <?if($clidtype==4){?>checked<?}?>>Ends with</td>
			</tr>
			<tr>
				<td align="left"><b>Userfield</b></td>				
				<td align="left"><INPUT TYPE="text" NAME="userfield" value="<?echo "$userfield";?>"></td>
				<td align="left"><input type="radio" NAME="userfieldtype" value="1" <?if((!isset($userfieldtype))||($userfieldtype==1)){?>checked<?}?>>Exact</td>
				<td align="left"><input type="radio" NAME="userfieldtype" value="2" <?if($userfieldtype==2){?>checked<?}?>>Begins with</td>
				<td align="left"><input type="radio" NAME="userfieldtype" value="3" <?if($userfieldtype==3){?>checked<?}?>>Contains</td>
				<td align="left"><input type="radio" NAME="userfieldtype" value="4" <?if($userfieldtype==4){?>checked<?}?>>Ends with</td>
			</tr>
			<tr>
				<td align="left"><b>Accountcode</b></td>				
				<td align="left"><INPUT TYPE="text" NAME="accountcode" value="<?=$accountcode?>"></td>
				<td align="left"><input type="radio" NAME="accountcodetype" value="1" <?if((!isset($accountcodetype))||($accountcodetype==1)){?>checked<?}?>>Exact</td>
				<td align="left"><input type="radio" NAME="accountcodetype" value="2" <?if($accountcodetype==2){?>checked<?}?>>Begins with</td>
				<td align="left"><input type="radio" NAME="accountcodetype" value="3" <?if($accountcodetype==3){?>checked<?}?>>Contains</td>
				<td align="left"><input type="radio" NAME="accountcodetype" value="4" <?if($accountcodetype==4){?>checked<?}?>>Ends with</td>
			</tr>			
			<tr>
			<td align="left"><b>Channel</b></td>				
				<td align="left"><INPUT TYPE="text" NAME="channel" value="<?=$channel?>"></td>
				<td colspan="4">&nbsp;</td>				
			</tr>
...
<tbody><tr><td bgcolor="#000000">			
	...
	?>
        ...
        <td bgcolor="#e22424"><img src="<?php echo base_url();?>modules/asterisk-stats/images/spacer.gif" width="<?=$widthbar?>" height="6"></td>
        </tr></tbody></table></td>
	...
	<br>
 	<IMG SRC="<?php echo base_url();?>asterisk-stats/graph_statbar/min_call=<?=$min_call?>&fromstatsday_sday=<?=$fromstatsday_sday?>&days_compare=<?=$days_compare?>&fromstatsmonth_sday=<?=$fromstatsmonth_sday?>&dsttype=<?=$dsttype?>&sourcetype=<?=$sourcetype?>&clidtype=<?=$clidtype?>&channel=<?=$channel?>&resulttype=<?=$resulttype?>&dst=<?=$dst?>&src=<?=$src?>&clid=<?=$clid?>&userfieldtype=<?=$userfieldtype?>&userfield=<?=$userfield?>&accountcodetype=<?=$accountcodetype?>&accountcode=<?=$accountcode?>" ALT="Stat Graph">
...
<br/>
	...
	<FORM METHOD=POST ACTION="<?php echo base_url();?>asterisk-stats/graph_hourdetail/posted=<?=$posted?>&min_call=<?=$min_call?>&fromstatsday_sday=<?=$fromstatsday_sday?>&days_compare=<?=$days_compare?>&fromstatsmonth_sday=<?=$fromstatsmonth_sday?>&dsttype=<?=$dsttype?>&sourcetype=<?=$sourcetype?>&clidtype=<?=$clidtype?>&channel=<?=$channel?>&resulttype=<?=$resulttype?>&dst=<?=$dst?>&src=<?=$src?>&clid=<?=$clid?>&userfieldtype=<?=$userfieldtype?>&userfield=<?=$userfield?>&accountcodetype=<?=$accountcodetype?>&accountcode=<?=$accountcode?>" target="superframe">		
	<!-- ** ** ** ** ** HOURLY LOAD ** ** ** ** ** -->
		<table class="bar-status" width="60%" border="0" cellspacing="1" cellpadding="2" align="center">
			...
			<tr>
				...
				<td class="bar-search" align="center" bgcolor="#acbdee">
					<input type="image"  name="image16" align="top" border="0" src="<?php echo base_url();?>modules/asterisk-stats/images/button-search.gif" />				
...
<br>
<center>
    <iframe name="superframe" src="<?php echo base_url();?>asterisk-stats/graph_hourdetail/posted=<?=$posted?>&min_call=<?=$min_call?>&fromstatsday_sday=<?=$fromstatsday_sday?>&days_compare=<?=$days_compare?>&fromstatsmonth_sday=<?=$fromstatsmonth_sday?>&dsttype=<?=$dsttype?>&sourcetype=<?=$sourcetype?>&clidtype=<?=$clidtype?>&channel=<?=$channel?>&resulttype=<?=$resulttype?>&dst=<?=$dst?>&src=<?=$src?>&clid=<?=$clid?>&userfieldtype=<?=$userfieldtype?>&userfield=<?=$userfield?>&accountcodetype=<?=$accountcodetype?>&accountcode=<?=$accountcode?>" BGCOLOR=white	width=770 height=800 marginWidth=0 marginHeight=0  frameBorder=0  scrolling=yes>
