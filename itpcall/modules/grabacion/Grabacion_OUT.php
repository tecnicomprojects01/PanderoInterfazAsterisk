...
//	echo $duration;
 ...
 $path = dirname(__FILE__) ."/monitor/".$t."/".$annio."/".$mes."/".$dia."/".$file;
  $path2 = "/var/spool/asterisk/monitor/".$t."/".$annio."/".$mes."/".$dia."/".$file;
  */
			...
			<td><?=$numero?>	</td>  
	              ...
	              <td>
 	              ...
 	              <td><?=$hora?>
	             	...
	             	<td>
<!--		<object data='<?php echo $pathurl; ?>' type='sound/gsm' autostart='false' width='200' height='20'></object> -->
			<embed src='<?php echo $pathurl; ?>' width=200 height=20 type="sound/gsm" loop=\'FALSE\' autostart=\'false\' > 
<!-- <audio src='<?php echo $pathurl; ?>' type='sound/gsm' controls pause > </audio> -->
			</td>
 			<td>
                 	<? if (file_exists("$path") ){
			?>
               	<a href="<?php echo $pathurl; ?>" target="_blank" style="text-decoration:none"><input type="button" value="Descargar"/></a>
			<?}else {echo "";}
			?>
			</td>
               </tr>
